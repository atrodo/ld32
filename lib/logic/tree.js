var ai = {
  bush: { distance: 1, cool_per: 1, aoe: true },
  oak:  { distance: 1, cool_per: 2, delay: '1s' },
  pine:  { distance: 8, cool_per: 0.4, delay: '2s' },
  spruce:  { distance: 10, cool_per: 0.1, delay: '2s' },
}
...
var Tree = Moo.class(function()
{
  ...
  this.method("atk_x", function()
  {
    return (this.atk.x() - this.x - 0.5) * this.atk_cool.get_pctdone()
  })

  this.method("atk_y", function()
  {
    return (this.atk.y() - this.y - 0.5) * this.atk_cool.get_pctdone()
  })
